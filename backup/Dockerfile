...
#ENV REACT_APP_COUPON_API_URL=http://coupon-api:8080
...
ENV REACT_APP_COUPON_API_URL=http://k8s-default-couponap-acba0908a2-1422117942.ap-northeast-2.elb.amazonaws.com
...
COPY backup/default.conf /etc/nginx/conf.d/default.conf
EXPOSE 80
